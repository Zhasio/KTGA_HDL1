SELECT CONCAT('V1_KTGA_POS_',Д.`КодДолжности`) AS POSITION_ID,
...
'1595C93AA3F5DCB2E053A747660A09BD' AS BUSINESS_UNIT_ID,
 CONCAT('V1_KTGA_POS_',Д.`КодДолжности`) AS POSITION_CODE,
'11A3CAC8E20AB4E6E053A747660AF6EC' AS BUSINESS_GROUP_ID,
 CONCAT('V1_KTGA_DEP_',Д.`КодПодразделения`) AS ORGANIZATION_ID,
 CONCAT('V1_KTGA_JOB_',Ф.`КодДол`) AS JOB_ID,
...
'POSITION_DATA' AS FT_ALTERNATE_REC,
 CONCAT('V1_KTGA_POS_',Д.`КодДолжности`) AS FT_ALTERNATE_KEY
FROM `Должности` Д
